...
struct FAnimBlueprintGeneratedConstantData : FAnimBlueprintConstantData
{
	...
	struct FAnimNodeFunctionRef __StructProperty_54;  // 0x68 ([x68)
	struct FAnimSubsystem_PropertyAccess AnimBlueprintExtension_PropertyAccess;  // 000036795] Package Id_MonsterEffect_GoblinWarrior_Nightmare (000036795] Package Id_MonsterEffect_GoblinWarrior_Nightmare)
...
struct FExecuteUbergraph_ABP_CaveExit
{
