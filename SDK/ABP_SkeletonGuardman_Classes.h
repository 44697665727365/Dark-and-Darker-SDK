#pragma once 
#include <ABP_SkeletonGuardman_Structs.h>
 
 
 
// AnimBlueprintGeneratedClass ABP_SkeletonGuardman.ABP_SkeletonGuardman_C
// Size: 0x1560(Inherited: 0x510)
struct UABP_SkeletonGuardman_C : UDCMonsterAnimInstanceBase
{
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_SkeletonGuardman.ABP_SkeletonGuardman_C.AnimGraph
	void ExecuteUbergraph_ABP_SkeletonGuardman(int32_t EntryPoint); // Function ABP_SkeletonGuardman.ABP_SkeletonGuardman_C.ExecuteUbergraph_ABP_SkeletonGuardman
}; 
