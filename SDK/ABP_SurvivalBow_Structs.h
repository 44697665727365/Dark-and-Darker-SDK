...
struct FAnimBlueprintGeneratedConstantData : FAnimBlueprintConstantData
{
	...
	struct FInputScaleBiasClampConstants __StructProperty_46;  // [x1C ([x1C)
...
struct FExecuteUbergraph_ABP_SurvivalBow
{
	int32_t EntryPoint;  // 0x0 (0x0)
	struct FDelegate K2Node_CreateDelegate_OutputDelegate;  // 0x4 (0x4)
	char pad_20[4];  // 0x14 (0x14)
	struct UAnimMontage* K2Node_CustomEvent_Montage;  // 0x18 (0x18)
	char pad_32_1 : 7;  // 0x20 (0x20)
	bool K2Node_CustomEvent_bInterrupted : 1;  // 0x20 (0x20)
	char pad_33[7];  // 0x21 (0x21)
	struct USkeletalMeshComponent* CallFunc_GetOwningComponent_ReturnValue;  // 0x28 (0x28)
