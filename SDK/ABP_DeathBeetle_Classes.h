...
struct UABP_DeathBeetle_C : UDCMonsterAnimInstanceBase
{
	...
	struct FAnimNode_ModifyBone AnimGraphNode_ModifyBone_2;  // 0xDD8 (0xDD8)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_2;  // 0xF00 (0xF00)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_2;  // 0xF20 (0xF20)
	struct FAnimNode_SaveCachedPose AnimGraphNode_SaveCachedPose;  // 0xF40 (0xF40)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_2;  // 0x1048 (0x1048)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose;  // 0x1070 (0x1070)
	struct FAnimNode_ModifyBone AnimGraphNode_ModifyBone;  // 0x1098 (0x1098)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;  // 0x11C0 (0x11C0)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;  // 0x11E0 (0x11E0)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool;  // 0x1200 (0x1200)


	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_DeathBeetle.ABP_DeathBeetle_C.AnimGraph
	void ExecuteUbergraph_ABP_DeathBeetle(int32_t EntryPoint); // Function ABP_DeathBeetle.ABP_DeathBeetle_C.ExecuteUbergraph_ABP_DeathBeetle
}; 
