...
struct UABP_Mimic_Medium_C : UDCMonsterAnimInstanceBase
{
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_Mimic_Medium.ABP_Mimic_Medium_C.AnimGraph
	void BlueprintThreadSafeUpdateAnimation(float DeltaTime); // Function ABP_Mimic_Medium.ABP_Mimic_Medium_C.BlueprintThreadSafeUpdateAnimation
	void ExecuteUbergraph_ABP_Mimic_Medium(int32_t EntryPoint); // Function ABP_Mimic_Medium.ABP_Mimic_Medium_C.ExecuteUbergraph_ABP_Mimic_Medium
}; 
