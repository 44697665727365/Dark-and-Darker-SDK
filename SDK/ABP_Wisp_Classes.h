...
struct UABP_Wisp_C : UDCMonsterAnimInstanceBase
{
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_Wisp.ABP_Wisp_C.AnimGraph
	void BlueprintThreadSafeUpdateAnimation(float DeltaTime); // Function ABP_Wisp.ABP_Wisp_C.BlueprintThreadSafeUpdateAnimation
	void ExecuteUbergraph_ABP_Wisp(int32_t EntryPoint); // Function ABP_Wisp.ABP_Wisp_C.ExecuteUbergraph_ABP_Wisp
}; 
