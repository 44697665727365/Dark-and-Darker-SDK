...
// Function GA_Lazy.GA_Lazy_C.AbilityActivated
...
struct FCancelled_A2900AB4447D2FBA3BEEDFB1A199FD19
{
...
struct FExecuteUbergraph_GA_Lazy
{
	...
	float CallFunc_GetAimRadius_ReturnValue;  // 0x260 (0x260)
	char pad_612[4];  // 0x264 (0x264)
	double CallFunc_SetDoublePropertyByName_Value_ImplicitCast;  // 0x268 (0x268)
	double CallFunc_SetDoublePropertyByName_Value_ImplicitCast_2;  // 0x270 (0x270)


}; 
 
 // Function GA_Lazy.GA_Lazy_C.ValidData_A2900AB4447D2FBA3BEEDFB1A199FD19
struct FValidData_A2900AB4447D2FBA3BEEDFB1A199FD19
{
	struct FGameplayAbilityTargetDataHandle Data;  // 0x0 (0x0)
