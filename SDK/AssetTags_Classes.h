...
struct UAssetTagsSubsystem : UEngineSubsystem
{
	...
	struct TArray<struct FName> K2_GetCollectionsContainingAsset(struct FSoftObjectPath& AssetPath); // Function AssetTags.AssetTagsSubsystem.K2_GetCollectionsContainingAsset
