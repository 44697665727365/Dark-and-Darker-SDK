...
struct FExecuteUbergraph_BP_CandleWallOn
{
	...
	bool GameplayTagsK2Node_SwitchGameplayTag_CmpSuccess_2 : 1;  // 0x2D1 (0x2D1)
	char pad_722[2];  // 0x2D2 (0x2D2)
	int32_t CallFunc_PostAkEvent_ReturnValue;  // 0x2D4 (0x2D4)
	int32_t CallFunc_PostAkEvent_ReturnValue_2;  // 0x2D8 (0x2D8)
	int32_t CallFunc_PostAkEvent_ReturnValue_3;  // 0x2DC (0x2DC)
	int32_t CallFunc_PostAkEvent_ReturnValue_4;  // 0x2E0 (0x2E0)
	int32_t CallFunc_PostAkEvent_ReturnValue_5;  // 0x2E4 (0x2E4)
	int32_t CallFunc_PostAkEvent_ReturnValue_6;  // 0x2E8 (0x2E8)
