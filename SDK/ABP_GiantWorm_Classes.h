#pragma once 
#include <ABP_GiantWorm_Structs.h>
 
 
 
// AnimBlueprintGeneratedClass ABP_GiantWorm.ABP_GiantWorm_C
// Size: 0xFE5(Inherited: 0x510)
struct UABP_GiantWorm_C : UDCMonsterAnimInstanceBase
{
	...
	struct FAnimNode_BlendSpacePlayer AnimGraphNode_BlendSpacePlayer;  // 0x640 (0x640)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_7;  // 0x6B0 (0x6B0)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_6;  // 0x6D0 (0x6D0)
	struct FAnimNode_StateResult AnimGraphNode_StateResult_6;  // 0x718 (0x718)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_5;  // 0x738 (0x738)
	...
	bool UnderGround : 1;  // 0xFE0 (0xFE0)
	char pad_4065_1 : 7;  // 0xFE1 (0xFE1)
	bool StateOnGround : 1;  // 0xFE1 (0xFE1)
	char pad_4066_1 : 7;  // 0xFE2 (0xFE2)
	bool ShouldPlayHitReactionNotSpawn : 1;  // 0xFE2 (0xFE2)
	char pad_4067_1 : 7;  // 0xFE3 (0xFE3)
	bool ShouldPlayStaggerNotSpawn : 1;  // 0xFE3 (0xFE3)
	char pad_4068_1 : 7;  // 0xFE4 (0xFE4)
	bool StateUnderGround : 1;  // 0xFE4 (0xFE4)


	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_GiantWorm.ABP_GiantWorm_C.AnimGraph
	void BlueprintThreadSafeUpdateAnimation(float DeltaTime); // Function ABP_GiantWorm.ABP_GiantWorm_C.BlueprintThreadSafeUpdateAnimation
	void ExecuteUbergraph_ABP_GiantWorm(int32_t EntryPoint); // Function ABP_GiantWorm.ABP_GiantWorm_C.ExecuteUbergraph_ABP_GiantWorm
}; 
