...
struct FExecuteUbergraph_BP_Mimic_Medium_Base
{
	...
	struct UABP_Mimic_Medium_C* K2Node_DynamicCast_AsABP_Mimic_Medium;  // 0x28 (0x28)
	char pad_48_1 : 7;  // 0x30 (0x30)
	bool K2Node_DynamicCast_bSuccess : 1;  // 0x30 (0x30)
	char pad_49[7];  // 0x31 (0x31)
	struct UABP_Mimic_Medium_C* K2Node_DynamicCast_AsABP_Mimic_Medium_2;  // 0x38 (0x38)
