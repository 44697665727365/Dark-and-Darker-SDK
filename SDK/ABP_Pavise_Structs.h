...
struct FExecuteUbergraph_ABP_Pavise
{
	int32_t EntryPoint;  // 0x0 (0x0)
	char pad_4[4];  // 0x4 (0x4)
	struct FItemData K2Node_Event_ItemData;  // 0x8 (0x8)
	char pad_168_1 : 7;  // 0xA8 (0xA8)
	bool CallFunc_EqualEqual_GameplayTag_ReturnValue : 1;  // 0xA8 (0xA8)
	char pad_169_1 : 7;  // 0xA9 (0xA9)
	bool CallFunc_EqualEqual_GameplayTag_ReturnValue_2 : 1;  // 0xA9 (0xA9)


}; 
 
 // Function ABP_Pavise.ABP_Pavise_C.OnItemDataUpdated_2
struct FOnItemDataUpdated_2
{
