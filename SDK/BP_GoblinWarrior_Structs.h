...
struct FExecuteUbergraph_BP_GoblinWarrior
{
	...
	struct UABP_GoblinWarrior_C* K2Node_DynamicCast_AsABP_Goblin_Warrior;  // 0x20 (0x20)
	char pad_40_1 : 7;  // 0x28 (0x28)
	bool K2Node_DynamicCast_bSuccess : 1;  // 0x28 (0x28)
	char pad_41[7];  // 0x29 (0x29)
	struct UABP_GoblinWarrior_C* K2Node_DynamicCast_AsABP_Goblin_Warrior_2;  // 0x30 (0x30)
	char pad_56_1 : 7;  // 0x38 (0x38)
	bool K2Node_DynamicCast_bSuccess_2 : 1;  // 0x38 (0x38)
	char pad_57[7];  // 0x39 (0x39)
	struct UABP_GoblinWarrior_C* K2Node_DynamicCast_AsABP_Goblin_Warrior_3;  // 0x40 (0x40)
	...
	char pad_2116_1 : 7;  // 0x844 (0x844)
	bool CallFunc_HasMatchingGameplayTag_ReturnValue : 1;  // 0x844 (0x844)
	char pad_2117[3];  // 0x845 (0x845)
	float CallFunc_GetDistanceTo_ReturnValue;  // 0x848 (0x848)
	char pad_2124_1 : 7;  // 0x84C (0x84C)
	bool CallFunc_Less_DoubleDouble_ReturnValue : 1;  // 0x84C (0x84C)
	char pad_2125[3];  // 0x84D (0x84D)
...
{
	struct FHitResult CallFunc_K2_SetRelativeRotation_SweepHitResult;  // 0x0 (0x0)
