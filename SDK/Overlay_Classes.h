...
{
	struct TArray<struct FOverlayItem> Overlays;  // 0x28 (0x28)
...
{
	struct UBasicOverlays* DefaultOverlays;  // 0x28 (0x28)
	struct TMap<struct FString, struct UBasicOverlays*> LocaleToOverlaysMap;  // 0x30 (0x30)
