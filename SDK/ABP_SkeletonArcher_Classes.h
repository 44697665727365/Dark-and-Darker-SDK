...
struct UABP_SkeletonArcher_C : UDCMonsterAnimInstanceBase
{
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_SkeletonArcher.ABP_SkeletonArcher_C.AnimGraph
	void ExecuteUbergraph_ABP_SkeletonArcher(int32_t EntryPoint); // Function ABP_SkeletonArcher.ABP_SkeletonArcher_C.ExecuteUbergraph_ABP_SkeletonArcher
}; 
