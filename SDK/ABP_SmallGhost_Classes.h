...
struct UABP_SmallGhost_C : UDCMonsterAnimInstanceBase
{
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_SmallGhost.ABP_SmallGhost_C.AnimGraph
	void BlueprintThreadSafeUpdateAnimation(float DeltaTime); // Function ABP_SmallGhost.ABP_SmallGhost_C.BlueprintThreadSafeUpdateAnimation
	void ExecuteUbergraph_ABP_SmallGhost(int32_t EntryPoint); // Function ABP_SmallGhost.ABP_SmallGhost_C.ExecuteUbergraph_ABP_SmallGhost
}; 
