...
struct ABP_GoblinMage_C : ABP_Goblin_C
{
	...
	void GameplayTagUpdated(struct FGameplayTag InGameplayTag, int32_t InCount); // Function BP_GoblinMage.BP_GoblinMage_C.GameplayTagUpdated
	void ExecuteUbergraph_BP_GoblinMage(int32_t EntryPoint); // Function BP_GoblinMage.BP_GoblinMage_C.ExecuteUbergraph_BP_GoblinMage
}; 
