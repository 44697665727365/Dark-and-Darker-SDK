...
struct UABP_SkeletonSpearman_C : UDCMonsterAnimInstanceBase
{
	...
	struct FAnimNode_LegIK AnimGraphNode_LegIK;  // 0x1338 (0x1338)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;  // 0x1430 (0x1430)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;  // 0x1450 (0x1450)


	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_SkeletonSpearman.ABP_SkeletonSpearman_C.AnimGraph
	void ExecuteUbergraph_ABP_SkeletonSpearman(int32_t EntryPoint); // Function ABP_SkeletonSpearman.ABP_SkeletonSpearman_C.ExecuteUbergraph_ABP_SkeletonSpearman
}; 
