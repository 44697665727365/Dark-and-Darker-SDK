...
struct UABP_Longbow_C : UItemWeaponAnimInstanceBase
{
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_Longbow.ABP_Longbow_C.AnimGraph
	void OnBlendingOut(struct UAnimMontage* Montage, bool bInterrupted); // Function ABP_Longbow.ABP_Longbow_C.OnBlendingOut
	void BlueprintInitializeAnimation(); // Function ABP_Longbow.ABP_Longbow_C.BlueprintInitializeAnimation
	void ExecuteUbergraph_ABP_Longbow(int32_t EntryPoint); // Function ABP_Longbow.ABP_Longbow_C.ExecuteUbergraph_ABP_Longbow
}; 
