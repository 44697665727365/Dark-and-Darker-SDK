...
// Function GA_LocustsSwarm.GA_LocustsSwarm_C.AbilityActivated
...
struct FK2_OnEndAbility : FK2_OnEndAbility
{
 ...
 // Function GA_LocustsSwarm.GA_LocustsSwarm_C.Cancelled_1FD2291E4AFD8978108B38829AE38FF5
struct FCancelled_1FD2291E4AFD8978108B38829AE38FF5
{
...
struct FEndSpell
{
	...
	struct ABP_AOE_LocustsSwarm_C* K2Node_DynamicCast_AsBP_AOE_Locusts_Swarm;  // [x8 ([00980506] ed: 0x1)
)
 ...
 // Function GA_LocustsSwarm.GA_LocustsSwarm_C.EventReceived_FE9A586F4866FC81C4266582AAD4E1C6
struct FEventReceived_FE9A586F4866FC81C4266582AAD4E1C6
{
...
struct FSpawnAoe
{
	...
	struct ABP_AOE_LocustsSwarm_C* K2Node_DynamicCast_AsBP_AOE_Locusts_Swarm;  // 0x230 (0x230)
	...
	double CallFunc_SetData_AreaRadius_ImplicitCast;  // 0x440 (0x440)


}; 
 
 // Function GA_LocustsSwarm.GA_LocustsSwarm_C.ExecuteUbergraph_GA_LocustsSwarm
struct FExecuteUbergraph_GA_LocustsSwarm
{
	...
	float CallFunc_GetRange_ReturnValue;  // 0x364 (0x364)
	float CallFunc_GetAimRadius_ReturnValue;  // 0x368 (0x368)
	...
	bool K2Node_Event_bIsSocketSightBlocked : 1;  // 0x420 (0x420)
	char pad_1057[7];  // 0x421 (0x421)
	struct AActor* CallFunc_GetAvatarActorFromActorInfo_ReturnValue;  // 0x428 (0x428)
	char pad_1072_1 : 7;  // 0x430 (0x430)
	bool K2Node_Event_bWasCancelled : 1;  // 0x430 (0x430)
	char pad_1073[7];  // 0x431 (0x431)
	double CallFunc_SetDoublePropertyByName_Value_ImplicitCast;  // 0x438 (0x438)
	double CallFunc_SetDoublePropertyByName_Value_ImplicitCast_2;  // 0x440 (0x440)


}; 
 
 // Function GA_LocustsSwarm.GA_LocustsSwarm_C.ValidData_1FD2291E4AFD8978108B38829AE38FF5
struct FValidData_1FD2291E4AFD8978108B38829AE38FF5
{
	struct FGameplayAbilityTargetDataHandle Data;  // 0x0 (0x0)
