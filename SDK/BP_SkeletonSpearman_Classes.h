#pragma once 
#include <BP_SkeletonSpearman_Structs.h>
 
 
 
// BlueprintGeneratedClass BP_SkeletonSpearman.BP_SkeletonSpearman_C
// Size: 0x1210(Inherited: 0x11B8)
struct ABP_SkeletonSpearman_C : ABP_DCMonsterBaseWithOptions_C
{
	...
	void GameplayTagUpdated(struct FGameplayTag InGameplayTag, int32_t InCount); // Function BP_SkeletonSpearman.BP_SkeletonSpearman_C.GameplayTagUpdated
	void ExecuteUbergraph_BP_SkeletonSpearman(int32_t EntryPoint); // Function BP_SkeletonSpearman.BP_SkeletonSpearman_C.ExecuteUbergraph_BP_SkeletonSpearman
}; 
