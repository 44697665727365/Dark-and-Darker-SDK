...
// Function GA_Ignite.GA_Ignite_C.OnCasted
...
struct FOnCasted : FOnCasted
{
 ...
 // Function GA_Ignite.GA_Ignite_C.AbilityActivated
...
struct FCancelled_7B308F884F7D295326C8F096A391101B
{
...
struct FValidData_7B308F884F7D295326C8F096A391101B
{
	struct FGameplayAbilityTargetDataHandle Data;  // 0x0 (0x0)
...
struct FExecuteUbergraph_GA_Ignite
{
	...
	struct UObject* CallFunc_GetCurrentSourceObject_ReturnValue;  // 0x350 (0x350)
	struct AActor* K2Node_Event_InTarget;  // 0x358 (0x358)
	struct FDesignDataGameplayAbility CallFunc_GetDesignDataGameplayAbility_ReturnValue;  // 0x360 (0x360)
	char pad_952_1 : 7;  // 0x3B8 (0x3B8)
	bool CallFunc_IsMatchingAbilityActivated_ReturnValue : 1;  // 0x3B8 (0x3B8)
