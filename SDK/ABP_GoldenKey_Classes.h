...
struct UABP_GoldenKey_C : UItemWeaponAnimInstanceBase
{
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_GoldenKey.ABP_GoldenKey_C.AnimGraph
	void ExecuteUbergraph_ABP_GoldenKey(int32_t EntryPoint); // Function ABP_GoldenKey.ABP_GoldenKey_C.ExecuteUbergraph_ABP_GoldenKey
}; 
